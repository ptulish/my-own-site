...
const PortfolioTeaser = () => {
    ...
    const categoryLabels = {
        ...
        webapp: t('portfolio_page.categories.webapp.label', 'Web apps'),
        saas: t('portfolio_page.categories.saas.label', 'SaaS'),
        blog: t('portfolio_page.categories.blog.label', 'Blog'),
